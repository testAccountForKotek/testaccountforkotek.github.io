document.addEventListener('DOMContentLoaded', function () {
    ...
    function getNextMonthNumber() {
        ...
        if (currentDateVariables.month + addToGetNextMonth > numberOfMonthsInTheYear) {
            return 1;
        } else {
            return currentDateVariables.month + addToGetNextMonth;
        }
    }
    ...
    function roundDaysCorners() {
        document.getElementById('day0').style.borderTopLeftRadius = valuesCSS.standardRadius;
        document.getElementById('day6').style.borderTopRightRadius = valuesCSS.standardRadius;

        if (gridSize === 35) {
            document.getElementById('day28').style.borderBottomLeftRadius = valuesCSS.standardRadius;
            document.getElementById('day34').style.borderBottomRightRadius = valuesCSS.standardRadius;
        } else {
            document.getElementById('day35').style.borderBottomLeftRadius = valuesCSS.standardRadius;
            document.getElementById('day41').style.borderBottomRightRadius = valuesCSS.standardRadius;
        }
    }
