import * as THREE from '../three/three.js-master/build/three.module.js';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const canvasWidth = (window.innerWidth * 0.66) * 0.7;
    const canvasHeight = window.innerHeight * 0.735;
